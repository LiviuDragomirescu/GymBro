...
const Record_Workout = ({navigation, route}) => {
    return (
      <View>
        <Template_Button navigation={navigation} img={image} Button_type={Record_Workout_Button} Button_name={"Record Workout"} username={route.params.username}></Template_Button>
      </View>
    )
  }
